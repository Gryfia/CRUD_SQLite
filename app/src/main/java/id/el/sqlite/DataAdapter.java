...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, int position) {
        ...
        String nik = mCursor.getString(mCursor.getColumnIndex(DBmain.row_bidang));
        String nama = mCursor.getString(mCursor.getColumnIndex(DBmain.row_nama));
        String jk = mCursor.getString(mCursor.getColumnIndex(DBmain.row_gender));
        String keluhan = mCursor.getString(mCursor.getColumnIndex(DBmain.row_status));
    ...
    public class DataViewHolder extends RecyclerView.ViewHolder{
        ...
        public DataViewHolder(@NonNull View itemView) {
            ...
            nikTV = itemView.findViewById(R.id.bidangTV);
            namaTV = itemView.findViewById(R.id.namaTV);
            jkTV = itemView.findViewById(R.id.genderTV);
            keluhanTV = itemView.findViewById(R.id.statusTV);
